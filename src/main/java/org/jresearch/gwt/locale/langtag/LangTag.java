...
public class LangTag implements ReadOnlyLangTag {
	 ...
	 *
	 * @param script The script, as a four-letter ISO 15924 code. {@code null} if
	 *               not defined.
	 *
	...
	private static boolean isExtension(final String s) {
		...
		return s.matches("[0-9a-wA-Wy-zY-Z]-[0-9a-zA-Z]+[-[0-9a-zA-Z]+]*");
	}
	 ...
	 */
	public static LangTag parse(final String s) throws LangTagException {
